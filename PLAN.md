...
TODAY'S GOAL: Slice 1 running end to end, ugly (O1). Intel sources + MCP transport settled, normaliser starting (O2). Contracts ready for Cockpit to build against (O3).
