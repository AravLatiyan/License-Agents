...
|---|---|---|---|---|
| T-026 | O2 | 2026-08-29 00:01 | 2h | Stub `detonate` returning `{available: false, note: "text-mode port incomplete"}` behind the same graceful-degradation shape as `domain_intel`/`url_reputation` — never left silently undone. Log the gap in §7, come back later |
