...
BLOCKED ON:   nothing
LAST UPDATED: 2026-08-26 14:25 · PR #1, #2, #3 merged (T-013/T-017/T-002/T-014+Qodo-fixes all on main); T-003, T-004, T-010, T-011, T-012 done (O2); PR #8 (T-012) — Qodo's "root pytest cannot import package" finding fixed with an explicit `pytest.ini`, 14/14 tests pass, pushed, not merged, waiting on Qodo re-review
```
