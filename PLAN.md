...
|---|---|---|---|---|---|
| 1 | **T-052** | Three evidence lanes streaming in parallel — *this is what makes subagents visible* | O3 | — | Direct follow-on to T-051 (just done) — the plan tree now shows lane status/one-line detail; this is the next Cockpit backlog item in order (§11) that gives each lane its own real UI |
