...
| 3 | **T-034** | Mark the four actions approval-required in `agent.json` — four sequential gates | O1 | — | T-025 disproven as an invalid task premise (see §7/§8) and pulled from this slot; T-034 is the next genuinely schema-supported O1 Slice 3 item, configuration only |
